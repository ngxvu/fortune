...
type FortuneInterface interface {
	...
	ProcessURLsItem(client *http.Client, urls model.Data) ([]model.DataItemCrawled, error)
}
...
func (s *FortuneService) ProcessURLsItem(client *http.Client, urls model.Data) ([]model.DataItemCrawled, error) {
	method := "GET"
